...
const translations = {
  en: {
    ...
    words: "Words",
    lines: "Lines",
    individualLetters: "Individual Letters",
    compoundLetters: "Compound Letters",
    vowels: "Vowels",
    tanween: "Tanween",
    maddLetters: "Madd Letters",
    sukoon: "Sukoon",
    tashdeed: "Tashdeed",
    finishLesson: "Finish Lesson",
    repeatLetters: "Repeat these letters until you master them.",
    jumma: "Jumma",
  ...
  ar: {
    ...
    words: "كلمات",
    lines: "خطوط",
    individualLetters: "حروف منفردة",
    compoundLetters: "حروف مركبة",
    vowels: "حركات",
    tanween: "تنوين",
    maddLetters: "حروف المد",
    sukoon: "سكون",
    tashdeed: "تشديد",
    finishLesson: "إنهاء الدرس",
    repeatLetters: "كرر هذه الحروف حتى تتقنها.",
    jumma: "الجمعة",
    eidUlFitr: "عيد الفطر",
  ...
  bn: {
    ...
    steps: "ধাপসমূহ",
    procedure: "পদ্ধতি",
    individualLetters: "একক অক্ষর",
    compoundLetters: "যুক্ত অক্ষর",
    vowels: "হরকত (স্বরবর্ণ)",
    tanween: "তানউইন",
    maddLetters: "মাদ্দ অক্ষর",
    sukoon: "সুকুন",
    tashdeed: "তাশদীদ",
    finishLesson: "পাঠ শেষ করুন",
    repeatLetters: "এই অক্ষরগুলো বারবার পড়ুন যতক্ষণ না আয়ত্ত হয়।",
    ampara: "আমপারা",
    words: "শব্দ",
    lines: "লাইন",
  },
