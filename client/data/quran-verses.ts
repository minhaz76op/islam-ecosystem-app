...
export const SURAH_VERSES: SurahVerses[] = [
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 8, arabic: "ثُمَّ لَتُسْأَلُنَّ يَوْمَئِذٍ عَنِ النَّعِيمِ", transliteration: "Thumma latus'alunna yawma'izin 'anin-na'eem", english: "Then you will surely be asked that Day about pleasure", bengali: "তারপর সেদিন তোমাদেরকে অবশ্যই নেয়ামত সম্পর্কে জিজ্ঞাসা করা হবে", audioUrl: getVerseAudioUrl(102, 8) }
    ]
  },
  {
    surahNumber: 104,
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 9, arabic: "فَأُمُّهُ هَاوِيَةٌ", transliteration: "Fa-ummuhoo haawiyah", english: "His refuge will be an abyss", bengali: "তার আশ্রয়স্থল হবে হাবিয়া (গভীর গর্ত)", audioUrl: getVerseAudioUrl(101, 9) },
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 2, arabic: "وَالْقُرْآنِ الْحَكِيمِ", transliteration: "Wal-Qur'aanil-Hakeem", english: "By the wise Qur'an", bengali: "প্রজ্ঞাপূর্ণ কুরআনের শপথ", audioUrl: getVerseAudioUrl(36, 2) },
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 2, arabic: "عَلَّمَ الْقُرْآنَ", transliteration: "'Allamal-Qur'aan", english: "Taught the Qur'an", bengali: "কুরআন শিক্ষা দিয়েছেন", audioUrl: getVerseAudioUrl(55, 2) },
